...
const Sidebar = ({ isDarkMode,isSideBar, toggleDarkMode }: darkMode) => {
    return (
        ...
        <div className={`w-50  ${isSideBar ? "sideBarToggle backdrop-blur-sm" : ""} transition duration-5000 ease-in-out z-20 sideBar h=[100vh] p-5 bg-white/3 shadow-gray-700 shadow-2xl ${isDarkMode ? "bg-white" : "bg-gray-700 "}`}>
            <h2 className="text-xl font-bold mb-6 text-center ">Nebula Admin</h2>
            <ul className="space-y-6">
                <li className="m-2 px-3 py-1 rounded text-left cursor-pointer hover:text-blue-600 hover:bg-gray-200"><i className="fas fa-chart-line font-black mx-2 "></i>Dashboard</li>
                ...
                <li className="m-2 px-3 py-1 rounded text-left cursor-pointer hover:text-blue-600 hover:bg-gray-200"><i className="fas fa-file-lines mx-2 text-xl text-blue-600"></i>Listes</li>
